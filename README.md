...
Regras:
  ...
  [R03] O botão "Finalizar Cadastro" esmaecido deve ter um texto "Por favor, preencha os dados obrigatórios" em cima em cor vermelha de fonte Nunit tamanho 7 em cima desse botão
  [R04] Deve haver campo de finalizar cadastro
  [R05] O botão "Finalizar Cadastro" deve ficar esmaecido se algum dos campos não estiverem preenchidos devidamente
  [R06] O botão "Finalizar Cadastro" esmaecido deve ter um texto "Por favor, preencha os dados obrigatórios" em cima em cor vermelha de fonte Nunit tamanho 7 em cima desse botão
...
- Nome e Sobrenome
  - mostrar sinal verde quando o campo estiver preenchido corretamente
  - destacar com contorno verde e sombreamento quando o campo estiver preenchido corretamente
- Sobrenome
